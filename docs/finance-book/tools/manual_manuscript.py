    ...
    ch(
            ...
            [
                ...
                (
                    ...
                    + p(
                        "给 ABS 排雷也用第 5 章那五问,但要加一个决定性的新变量——底层资产质量。池中每笔贷款的违约率、提前还款率、回收率,决定了现金流到底有多少量;一旦经济下行,成百上千笔小额贷款会一起出问题,整个证券的评级和价格随之重估;而且 ABS 通常有多层分级,优先级先拿钱,劣后级先挨亏——你买的那层在队伍哪个位置,直接决定你拿到的是分红还是坏账。"
                    ),
                ),
                (
                    "跨资产共同语言",
...
ch(
            ...
            [
                ...
                (
                    ...
                    + p(
                        "对量化读者有一个直接的用处:保险资金是市场上最典型的一类“久期需求型买方”。每年开门红收完保费,配置压力集中释放,长债利率容易被它买下去;反之偿付能力吃紧、权益波动太大时,它又会阶段性抛债。机构行为是利率曲线的重要驱动之一——第六章讲过曲线由央行之手和市场预期决定,而市场预期里,就坐着保险、银行、理财这几个大买家的钱包。"
                    ),
                ),
                (
                    "读保单:先把五件事找出来",
...
ch(
            ...
            [
                ...
                (
                    ...
                    + p(
                        "所以你得建立一个新的度量衡:别把“利率 0%”读成“货币政策最松”,读成“货币政策已用光常规弹药”。想判断政策对市场的真正拉动力,看的不是绝对价格而是边际变化——从 5% 降到 4% 和从 1% 降到 0%,在实际利率空间里根本不是同一回事。第四章讲的费雪“名义=实际+通胀预期”,在这里是救命的公式。"
                    ),
                ),
                (
                    "一价定律打脸现场:巨无霸指数",
                    ...
                    + p(
                        "这类观察的意义在于:判断汇率、物价水平、生活成本时,必须区分“可贸易品”和“不可贸易品”,一个国家的汇率升降,对两类商品的作用路径完全不同——这就是看汇率新闻时该用的第一把刀,也让“xx 国东西便宜所以被低估”这类直觉立刻露馅。回看书里第六章汇率,对号入座立刻清楚得多。"
                    ),
                ),
                (
                    "格雷欣法则:坏钱为什么传遍世界",
                ...
                (
                    ...
                    + p(
                        "给你的实战警句:不要用历史相关性去论证当前安全。太平越久,历史数据越缺危机样本,你的风控模型越觉得世界太平——而世界的危机倾向恰恰跟“太平历史的长度”成正比。这是第九章危机四百年反反复复出演的同一个剧本,这一次换了个命名权。"
                    ),
                ),
                (
                    "费雪的债务-通缩螺旋:越还债越危险",
                ...
                (
                    ...
                    + p(
                        "对量化研究者,这是最值钱的世界观。第一章学到的价格模型(现金流贴现)假设市场有效,是“远处逼近的目标”;Grossman-Stiglitz 给的是你永远到不了、但必须不停逼近的那个目标——你的超额收益既不是白捡的,也不是命中注定为零,你赚的是其他懒于研究的人留下来的信息报酬。这本书所有后续因子、回测、模型,都活在“市场大体有效,但永远不完全有效”这个狭缝里。"
                    ),
                ),
                (
                    "货币幻觉:涨薪百分之五,其实更穷了",
                    ...
                    + p(
                        "最专业的反幻觉武器,就是第一章就学过的“名义收益和实际收益”分拆。做任何长期决策——攒钱、定养老金目标、比较两个年代的行业——先把所有数字折回同一个购买力单位,再谈多少。连国家养老金发放、企业年金替代率、甚至一辈子的收入曲线,没有这一步折现,看到的全是货币幻觉的哈哈镜。"
                    ),
                ),
                (
                    "收束:把悖论当指南针用",
                    ...
                    + p(
                        "回过头看,前面学的每一章都被这一节连了一遍:第一章鱼票是节制悖论的微缩版;第三、四章金融机构在流动性陷阱里原形毕露;第五章 A 股 2018 年质押危机是合成谬误的实录;第九章危机史是明斯基时刻的不断重演;央行章节是费雪债务通缩螺旋的现代战役手册。金融研究做到最后,大概就是在这些反直觉的机制里,找到现实的标定点。"
                    ),
                ),
            ],
            [
...
ch(
            ...
            [
                ...
                (
                    ...
                    + p(
                        "最后一个小提醒:保险不该用来理财。凡是带返还、分红、理财字样的保险,看似两项合一,实际是把一个复杂产品(理财)价格藏到另一个本该便宜的产品(保障)里。你可以自己在表格里剥开:纯保障一年要多少钱,返还部分按 IRR 算是多少——一算 IRR 基本绷不住。这条跟前面写产品文件阅读的章节会在第七章继续同化。"
                    ),
                ),
                (
                    "长期资产按目标分钱:先分桶,不是先选股",
                ...
                (
                    "对上书的接口:家庭配置是第一章的鱼塘",
                    p(
                        "如果你倒了回去翻第一章那座只有鱼的小岛,会发现全章都是一个家庭资产配置的隐喻。应急金就是老仓的库眼——没库眼的人只能今天吃今天捕,这就是穷人没有资本的实质。保险是老仓改行变成的风险互助——鱼干了别人分你一点。长期投资是买渔网而非买鱼——买生产能力而不是消耗品。"
                    )
                    + p(
...
ch(
            ...
            [
                ...
                (
                    ...
                    + p(
                        "先把四条命在纸上画出来:涨过敲出价,提前敲出,拿满期票息走人;没敲出也没敲入,到期拿票息;敲入没敲出,到期按标的跌幅赔;敲入又敲出,拿回本金加回调收益。每一条命对应一种市场路径,结构化产品的本质就是把这个路径依赖表换了个壳卖给你。书里第六章雪球那两节把推演演到过最小颗粒度,这里你只要会对照确认书读一遍,不掉进“以为买的是固收”这个坑就赢了大多数人。"
                    ),
                ),
                (
                    "别买读三遍还读不懂的产品",
                    ...
                    + p(
                        "看清的还是看不懂的,各自都有对应的动作。看清的:把关键条款记进自己的账本(可按第六章 39、40 单元讲的项目目录结构,建一个 products/ 文件夹分门别类归档);看不懂的:进黑名单,无论收益怎么诱人都别碰——回头你只会感谢那条原则一次,但常常就是那一次,决定了所有其他的事有没有机会继续发生。"
                    ),
                ),
            ],
            [
