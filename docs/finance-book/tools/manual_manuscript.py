            ...
            [
                ...
                (
                    ...
                    + p(
                        ...
                        "四道安全垫各管一段",
                        "一句话记住:存款保险管“储户不用跑”(中国 50 万/人/行、美国 25 万美元);央行流动性支持管“银行临时缺现金”(白芝浩规则:好抵押、罚息价、额度管够);资本监管管“股东的钱先垫”(总资本充足率 ≥ 8%);流动性覆盖率管“30 天全挤兑也扛得住”(高质量流动性资产 ≥ 30 天净流出 100%)。它们拦的是踩踏链条上的不同环节,不是把坏贷款变好的魔法。",
                    ),
