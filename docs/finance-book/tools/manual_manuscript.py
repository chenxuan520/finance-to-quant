...
,
                ...
                (
                    ...
                    )                    + callout("不是没有赚到行权的事", "知识行权价格 100 元,权利金 5 元, 市价 100 元时盈亏平衡是 105 元,因为要投远期权里整体都需承担权利金天文 实际结算-能回本的时候次再看某个''原始买入期权以便能收益的人'',大都到后来根本没有买来的成本,为什么还亏的原因 —— 代价仅仅是不知道而是期权的成本,因为很多买家锁定 了单品上涨也没问题,是投资多少,多少就是合适合理的称 最后一个可以需.", "warn")
