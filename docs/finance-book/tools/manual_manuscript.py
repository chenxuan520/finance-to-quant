    ...
    ch(
            ...
            [
                ...
                (
                    ...
                    "名义百分之五,实际负二点七八",
                    "手算校准:年初一万,年底一万零五百;同一年那一篮子货,从一万涨到一万零八百。精确算法是除法——一万零五百除以一万零八百,约等于零点九七二二,购买力只剩年初的九成七多一点,实际收益约负百分之二点七八。减法算出的负三只是近似:口算用减法,做研究用除法,两个都要会。",
                )

                    + callout(
                        "面额大小不是货币价值——韩元和日元的错觉",
                        "1 韩元约兑 0.005 元人民币,1 日元约兑 0.05 元,1 美元约兑 7 元。看数字,美元“大”、韩元“小”,好像韩国日本经济不行。其实面额只是记账单位的选择:这两家的单位在战后被通胀磨小了(韩元是 1950 年代战争通胀,日元是二战定型在 360 日元兑 1 美元),并不是今天的经济不行。真正衡量购买力硬不硬,得看购买力平价:同样一个巨无霸汉堡,在东京、首尔、纽约大概会花多少当地钱——这一比,三国货币的真实差距远没有面额看着那么夸张。它和名义/实际收益是同一个圈套:“数字变大”从来都不是“变富”的信任证据。",
                    )
            ...
            [
                ...
                (
                    ...
                    + p(
                        ...
                        "少数成交,给全体标价",
                        "这张卡就记一句话:市场上只有几百万股今天真正易手,但价格会把全部 10 亿股重新估价。你账户里的浮盈浮亏,就是这种边际定价的产物——而不是公司今天真的多了 / 少了那么多现金。",
                    )
                    ...
                    + callout(
                        "一级和二级,一句话分清",
                        "钱从投资者口袋流出去那一刻,流进谁手里,就把它归到哪个市场:流进上市公司账户的是一级市场(新股、新债、增发);流进另一个投资者手里的是二级市场(交易软件里每天买到的那些)。前者是“出生”,后者是“流通”。看到 IPO 新闻就用一级市场的视角想(发行人拿钱),看到交易行情涨跌就用二级市场的视角想(存量换手)——视角一对,后面所有术语都会各就各位。",
                    ),
                ),
                (
                    "成交不是终点,后面还有清算和交收",
