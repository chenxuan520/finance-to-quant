            ...
            [
                ...
                (
                    ...
                    + p(
                        ...
                        "这笔账是全部投资的原型",
                        "投资的通用句式只有一句:今天押一份确定的代价,赌明天一串持续的不确定增量。再看任何项目,先把这三列摆出来——今天我付掉多少、明天能多收多少、这增量能持续几个月几年——三列填不出来,就别往上加杠杆。",
                    )
...
,
                ...
                (
                    ...
                    + p(
                        ...
                        "利率如何把好客户赶出门",
                        "底层机制:信息不对称的情况下,市场只能按“中间价”给利率——这个价对诚实借款人偏贵,对快倒的借款人偏便宜。讲理的撤退,投机的留下,再抬高利率,再赶走一波讲理的。要靠披露、审计、抵押这些“看底细”的制度,把利率和借款人的真实质量重新勾连起来,不然定价永远在用良币驱逐良币。",
                    )
                ...
                (
                    ...
                    + p(
                        ...
                        "五倍杠杆下的两成下跌",
                        "杠杆的真正功用不是放大收益,是放大波动。记住一个简单的杠杆讲法:总资产跌幅 ÷ 杠杆率,才是本金实际要承受的损失。自由钱 100 万撬动 500 万(5 倍杠杆),资产只跌 20%,本金归零。看任何用杠杆的产品,先算这个换算,别只盯着预期的收益率。",
                    )
            ...
            [
                ...
                (
                    ...
                    + p(
                        ...
                        "三笔交易,一次过户",
                        "清算的关键动作就两个字:轧差。把全天所有纠缠的买卖先算成每个参与者的净头寸——甲净卖多少、乙净得多少——再按净额过户一次就完事,而不是逐笔搬三次。没有轧差,市场多成交一笔就多一次资金划转、多一份对手违约的机会;有了它,几千笔交易的血流最终只走几条水管。",
                    )
            ...
            [
                (
                    ...
                    + p(
                        ...
                        "远期买的是确定,不是便宜",
                        "拆两句话:第一,签远期赌的不是市场,是双方互相在意预算;第二,事件真的按你的判断走时,不要后悔签过它——那等于拿着理赔单后悔当初为什么买保险。远期的工作不是决定谁赚谁亏,是“让一个人在今天就把明天锁住”。",
                    )
,
                ),
                (
                ...
                (
                    ...
                    + p(
                        ...
                        "换月价差:回测最容易凭空生钱的一处",
                        "换月的本质是合约水位不同,不代表标的真的涨了二十元。关键的校验动作只有一个:回测里所有期货收益,都必须用“水到多少乘以实际张数变化”来叠加,而不是把近月和远月两个收盘价首尾拼成一根曲线——直接拼出来的那根曲线,强行情里的那种超额,一大半都是你自己拼出来的。",
                    )
