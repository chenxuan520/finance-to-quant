...
(function () {
  ...
  var CHAPTERS = [
    ...
    { num: 6, title: '基本面与宏观:数字背后的公司和经济', file: 'chapter-06.html', part: '第一部分 · 金融世界的底层结构' },
    { num: 7, title: '国家为什么有穷有富: 从起飞到中等收入陷阱', file: 'chapter-07.html', part: '第一部分 · 金融世界的底层结构' },
    { num: 8, title: 'A 股的交易机器:从下单到成交', file: 'chapter-08.html', part: '第二部分 · A 股市场与交易机器' },
    { num: 9, title: '看懂行情:屏幕上的数字和基准', file: 'chapter-09.html', part: '第二部分 · A 股市场与交易机器' },
    { num: 10, title: '收益、风险与市场为什么难赢', file: 'chapter-10.html', part: '第三部分 · 收益、风险与投资评价' },
    { num: 11, title: '量化的起点:因子和数据', file: 'chapter-11.html', part: '第四部分 · 量化研究从因子开始' },
    { num: 12, title: '回测与机器学习:在历史里排练', file: 'chapter-12.html', part: '第四部分 · 量化研究从因子开始' },
    { num: 13, title: '从预测到交易:组合、执行与风控', file: 'chapter-13.html', part: '第四部分 · 量化研究从因子开始' },
    { num: 14, title: '量化行业和个人的路线', file: 'chapter-14.html', part: '第五部分 · 量化行业与策略版图' },
    { num: 15, title: '量化策略版图与指数增强', file: 'chapter-15.html', part: '第五部分 · 量化行业与策略版图' },
    { num: 16, title: '市场中性与 CTA 趋势', file: 'chapter-16.html', part: '第五部分 · 量化行业与策略版图' },
    { num: 17, title: '套利与高频:更快更精细的战场', file: 'chapter-17.html', part: '第五部分 · 量化行业与策略版图' },
    { num: 18, title: '量化产品、监管与合规', file: 'chapter-18.html', part: '第五部分 · 量化行业与策略版图' },
    { num: 19, title: '一个量化项目的代码骨架 与 公式和指标速查', file: 'chapter-19.html', part: '第六部分 · 项目实战与工程化' },
    { num: 20, title: '量化项目的工程骨架与速查', file: 'chapter-20.html', part: '第六部分 · 项目实战与工程化' },
    { num: 21, title: '实战一:从零做一个指数增强回测', file: 'chapter-21.html', part: '第六部分 · 项目实战与工程化' },
    { num: 22, title: '实战二:市场中性模拟盘与上线检查', file: 'chapter-22.html', part: '第六部分 · 项目实战与工程化' },
    { num: 23, title: '避坑:常见错误和如何读研究', file: 'chapter-23.html', part: '第六部分 · 项目实战与工程化' },
    { num: 24, title: '心理、资金管理与一次复盘', file: 'chapter-24.html', part: '第六部分 · 项目实战与工程化' },
    { num: 25, title: '全书复盘:从一条鱼到一个量化系统', file: 'chapter-25.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 26, title: '职业路线与长期学习', file: 'chapter-26.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 27, title: '术语复盘:用人话再讲一遍', file: 'chapter-27.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 28, title: '场景练习:开户软件和基金月报', file: 'chapter-28.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 29, title: '场景练习:回测报告和模拟盘', file: 'chapter-29.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 30, title: '场景练习:第一次小资金实盘', file: 'chapter-30.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 31, title: '最终清单:动手前必须真正懂的事', file: 'chapter-31.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 32, title: '自检判断题与一个反面案例', file: 'chapter-32.html', part: '第七部分 · 路线、复盘与检查清单' },
    { num: 33, title: '一个稳妥的项目与结语', file: 'chapter-33.html', part: '第七部分 · 路线、复盘与检查清单' }
  ];
